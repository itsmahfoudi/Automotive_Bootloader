...
#define CONTROL_SPSEL_Msk (1UL << CONTROL_SPSEL_Pos) /*!< CONTROL: SPSEL Mask */
    ...
    typedef struct
    {
        ...
        uint32_t RESERVED1;
        __IOM uint32_t SHP[2U]; /*!< Offset: 0x01C (R/W)  System Handlers Priority Registers.
                                   [0] is RESERVED */
        __IOM uint32_t
...
/**
  ...
  \brief    Cortex-M1 Core Debug Registers (DCB registers, SHCSR, and DFSR) are only accessible
  over DAP and not via processor. Therefore they are not covered by the Cortex-M1 header file.
  @{
 */
...
#define __NVIC_GetPriorityGrouping() (0U)
    ...
    __STATIC_INLINE void __NVIC_SetVector(IRQn_Type IRQn, uint32_t vector)
    {
        ...
        /* ARM Application Note 321 states that the M1 does not require the architectural
         * barrier */
    }

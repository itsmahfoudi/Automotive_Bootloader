...
/* Includes ------------------------------------------------------------------*/
#include "./../../../CM7/Core/Inc/stm32h7xx_nucleo_conf.h"
...
#define STM32H7XX_NUCLEO_BSP_VERSION                                                          \
    ((STM32H7XX_NUCLEO_BSP_VERSION_MAIN << 24) | (STM32H7XX_NUCLEO_BSP_VERSION_SUB1 << 16)    \
     | (STM32H7XX_NUCLEO_BSP_VERSION_SUB2 << 8) | (STM32H7XX_NUCLEO_BSP_VERSION_RC))
...
#define COM_POLL_TIMEOUT 1000
    ...
    /** @defgroup STM32H7XX_NUCLEO_LOW_LEVEL_Exported_FunctionsPrototypes LOW LEVEL Exported
